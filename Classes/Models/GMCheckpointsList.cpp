...
void GMCheckpointsList::setRandRange()
{
    for (int i = 0; i < getStrangeCount(); i++) {
        ...
        if (i == 0) {
            ...
            //            log("0 i = %d range1 = %d range2 = %d rate = %f",i , strange->_interval_range1,strange->_interval_range2,strange->_rate);
            if (strange) {
    ...
    //        log("1-> i = %d range1 = %d range2 = %d rate = %f",i , strange->_interval_range1,strange->_interval_range2,strange->_rate);
    //    }
}
