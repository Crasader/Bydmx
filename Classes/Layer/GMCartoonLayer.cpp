...
bool GMCartoonLayer::init()
{
    ...
    CCMenuItem *item = CCMenuItemImage::create("cartoon/tiaoguo1.png", "cartoon/tiaoguo2.png", CC_CALLBACK_1(GMCartoonLayer::tiaoguoAction,this));
...
void GMCartoonLayer::tiaoguoAction(Ref *object){
    
    this->cleanup();
    
    CCScene *pScene = CCTransitionFade::create(2.0, GMMainLayer::scene(), Color3B::WHITE);
...
void GMCartoonLayer::setLabel(const char *string)
{
    ...
    tempLabelt->setColor(Color3B::WHITE);//ccWHITE  //ccc3(211,105,58)
...
void GMCartoonLayer::initElement1()
{
    ...
    scrollView1 = ScrollView::create();// 位置不是居中的
    scrollView1->setPosition(Vec2::ZERO);
    scrollView1->setContentOffset(Vec2::ZERO);
    ...
    scrollView1->setDirection(ScrollView::Direction::HORIZONTAL);  //设置滚动的方向，有三种可以选择
...
void GMCartoonLayer::initElement3()
{
    ...
    scrollView3 = ScrollView::create();// 位置不是居中的
    scrollView3->setPosition(Vec2::ZERO);
    scrollView3->setContentOffset(Vec2::ZERO);
    ...
    scrollView3->setDirection(ScrollView::Direction::HORIZONTAL);  //设置滚动的方向，有三种可以选择
...
//    layer->setContentSize(CCSizeMake(tempW*Scale_Y, WINSIZE_H));
    ...
    scrollView4 = ScrollView::create();// 位置不是居中的
    scrollView4->setPosition(Vec2::ZERO);
    scrollView4->setContentOffset(Vec2::ZERO);
    ...
    scrollView4->setDirection(ScrollView::Direction::HORIZONTAL);  //设置滚动的方向，有三种可以选择
