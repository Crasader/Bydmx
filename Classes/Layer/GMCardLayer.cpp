...
//    CCRemoveUnusedSpriteFrames();
	...
	listener->onTouchBegan = CC_CALLBACK_2(GMCardLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(GMCardLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(GMCardLayer::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(GMCardLayer::onTouchCancelled, this);
...
void GMCardLayer::intScorllView()
{
    ...
    m_pScrollView->setDirection(ScrollView::Direction::HORIZONTAL);  //设置滚动的方向，有三种可以选择
...
//    selectedSprite1->setFlipX(true);
//    arrow1 = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMCardLayer::arrowAtion1));
...
//    arrow2 = CCMenuItemSprite::create(normalSprite2, selectedSprite2, CC_CALLBACK_1(GMCardLayer::arrowAtion2));
...
//    CCMenuItemSprite *back1 = CCMenuItemSprite::create(xuanzgk005, xuanzgk006, CC_CALLBACK_1(GMCardLayer::backAction));
...
//    CCMenuItem *gold = CCMenuItemSprite::create(xuanzgk001, xuanzgk002, CC_CALLBACK_1(GMCardLayer::goleAction));
...
//    startMenu->setPosition(ccp(WINSIZE_W-10*Scale_X,5*Scale_X));
    ...
    otherMenu->setPosition(Vec2::ZERO);
...
//    }
    ...
    for(int j = 0; j < child.size(); j++){
        CCMenuItemSprite* temp = (MenuItemSprite*)child.at(j);
...
void GMCardLayer::chooseLevel(Ref *object)
{
...
//#pragma mark -
//#pragma mark ation
void GMCardLayer::arrowAtion1(Ref *pSender)
{
...
void GMCardLayer::arrowAtion2(Ref *pSender){
...
void GMCardLayer::backAction(Ref *pSender){
    this->cleanup();
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
...
void GMCardLayer::goleAction(Ref *pSender)
{
...
void GMCardLayer::startAction(Ref *pSender)
{
...
bool GMCardLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
void GMCardLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
void GMCardLayer::onTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
    if(m_pScrollView){
...
void GMCardLayer::onTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (isSelectCheckpoints) {
        CCLayer *eachLevel = (CCLayer*)m_pLayer->getChildByTag(EL_Tag00+checkpoints_index);
        if (eachLevel) {
