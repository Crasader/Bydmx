...
void GMWheelLayer::onEnter()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(GMWheelLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(GMWheelLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(GMWheelLayer::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(GMWheelLayer::onTouchCancelled, this);
...
bool GMWheelLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{

    return true;
}

void GMWheelLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{

}

void GMWheelLayer::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{

}

void GMWheelLayer::onTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
