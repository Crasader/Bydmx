...
void GMPauseLayer::initElement()
{
   ...
   GameMode pauseGameMode = GMPublicMethod::sharedPublicMethod()->getGameMode();
    ...
    if (pauseGameMode == Boot_Mode) {
        ...
        item1 = CCMenuItemSprite::create(normalSprite6, NULL, CC_CALLBACK_1(GMPauseLayer::chooseCard,this));
        ...
        item1 = CCMenuItemSprite::create(normalSprite6, selectedSprite7, CC_CALLBACK_1(GMPauseLayer::chooseCard,this));
    }
    item1->setPosition(ccp(WINSIZE_W/2, WINSIZE_H/2));
    array.pushBack(item1);
    //继续
    ...
    CCMenuItem *item2 = CCMenuItemSprite::create(normalSprite4, selectedSprite5, CC_CALLBACK_1(GMPauseLayer::continueTheGame,this));
    array.pushBack(item2);
    ...
    if(billingModel==B_91_IOS || billingModel == B_91_Android){
        ...
        item3 = CCMenuItemSprite::create(normalSprite3, selectedSprite3, CC_CALLBACK_1(GMPauseLayer::enterFeedback,this));
    }
    else {
        ...
        item3 = CCMenuItemSprite::create(normalSprite3, NULL, CC_CALLBACK_1(GMPauseLayer::videoAction,this));
    }
    item3->retain();
    array.pushBack(item3);
    //游戏帮助
    ...
    CCMenuItem *item4 = CCMenuItemSprite::create(normalSprite8, selectedSprite9, CC_CALLBACK_1(GMPauseLayer::helpAction,this));
    array.pushBack(item4);
    //重新开始
    ...
    CCMenuItem *item5 = CCMenuItemSprite::create(normalSprite12, selectedSprite13, CC_CALLBACK_1(GMPauseLayer::againAction,this));
    array.pushBack(item5);
    //返回
    ...
    CCMenuItem *item6 = CCMenuItemSprite::create(normalSprite10, selectedSprite11, CC_CALLBACK_1(GMPauseLayer::backAction,this));
    array.pushBack(item6);
...
/////////////////////////////////////////////////////////////////
    ...
    for(int j = 0; j < child.size(); j++){
        CCMenuItem*temp = (MenuItem*)child.at(j);
...
void GMPauseLayer::chooseCard(Ref *pSender)
{
...
void GMPauseLayer::continueTheGame(Ref *pSender){
...
void GMPauseLayer::enterFeedback(Ref *pSender){
...
void GMPauseLayer::videoAction(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
...
void GMPauseLayer::helpAction(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
//    GMAudioPlay::sharedAudioPlay()->stopBGMusic();
    
    
//    CCScene *pScene = CCTransitionFade::create(0.0, GMHelpLayer::scene(), Color3B::WHITE);
//    CCDirector::sharedDirector()->replaceScene(pScene);
...
void GMPauseLayer::againAction(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->stopBGMusic();
...
void GMPauseLayer::backAction(Ref *pSender)
{
...
void GMPauseLayer::setExitLayer(){
    ...
    if (exitLayer==NULL) {
        ...
        CCMenuItem *menuItem1 = CCMenuItemSprite::create(normalSpriteOK, selectedSpriteOK, CC_CALLBACK_1(GMPauseLayer::confirmAtion,this));
        menuItem1->setTag(1);
        ...
        CCMenuItem *cancel = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMPauseLayer::cancelAtion,this));
        cancel->setTag(2);
...
void GMPauseLayer::confirmAtion(Ref *object){
    ...
    CCScene *pScene = CCTransitionFade::create(0.0, GMIntroLayer::scene(), Color3B::WHITE);
    CCDirector::sharedDirector()->replaceScene(pScene);
}

void GMPauseLayer::cancelAtion(Ref *object){
...
//    CCTouchDispatcher::sharedDispatcher()->addTargetedDelegate(this, kCCMenuHandlerPriority - 1, true);
	...
	listener->onTouchBegan = CC_CALLBACK_2(GMPauseLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(GMPauseLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(GMPauseLayer::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(GMPauseLayer::onTouchCancelled, this);
...
bool GMPauseLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
void GMPauseLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_bTouchedMenu) {
...
void GMPauseLayer::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_bTouchedMenu) {
...
void GMPauseLayer::onTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_bTouchedMenu) {
        menu->ccTouchEnded(pTouch, pEvent);
        m_bTouchedMenu = false;
