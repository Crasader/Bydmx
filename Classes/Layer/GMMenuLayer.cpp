...
//    normalSprite->setColor(ccc3(0,0,3));
    ...
    pauseItem = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(GMMenuLayer::pauseAction,this));
    ...
    CCMenuItemSprite *magnificat = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMMenuLayer::setMagnificationModel,this));
...
//    mainmenu011->getContentSize().width;
    ...
    minusItem = CCMenuItemSprite::create(normalSprite16, selectedSprite17, CC_CALLBACK_1(GMMenuLayer::smallerAction,this));
    ...
    plusItem = CCMenuItemSprite::create(normalSprite18, selectedSprite19, CC_CALLBACK_1(GMMenuLayer::largerAction,this));
    ...
    buyEnergy = CCMenuItemSprite::create(bnormalSprite, bselectedSprite, CC_CALLBACK_1(GMMenuLayer::bugEnergyAction,this));
...
//    menuLayer->addSkill(this,menu_selector(GMGameLayer::usedSkill1),menu_selector(GMGameLayer::usedSkill2));
    ...
    skill1 = CCMenuItemSprite::create(normalSprite14, selectedSprite1, CC_CALLBACK_1(GMMenuLayer::usedSkill1,this));
    skill1->setTag(1);
    ...
    skill2 = CCMenuItemSprite::create(normalSprite14a, selectedSprite2,CC_CALLBACK_1(GMMenuLayer::usedSkill2,this));
    skill2->setTag(2);
...
void GMMenuLayer::usedSkill1(Ref *object){
    ((GMGameLayer*)delegateGame)->usedSkill1(object);
}

void GMMenuLayer::usedSkill2(Ref *object){
...
void GMMenuLayer::bugEnergyAction(Ref *object){
...
{
	Vector<SpriteFrame*> temploading;
    char strName[30] = {0};
    for (int j = 1; j <= 4; j++) {
        ...
        temploading.pushBack(spriteFrame);
    }
...
void GMMenuLayer::setEffect()
{
    ...
    junengEffect->setPosition(ccp(cannon->getContentSize().width/2,130));
...
void GMMenuLayer::smallerAction(Ref *pSender)
{
    if (!isLaser)
    {
//        cannonIndex--;
...
void GMMenuLayer::largerAction(Ref *pSender)
{
    if (!isLaser)
    {
//        cannonIndex++;
...
void GMMenuLayer::removeTaskBox()
{
    ...
    Vector<Node*> node;
	node = taskLayer->getChildren();
    for(int i = 0; i < node.size(); i++){
        taskLayer->removeChild(node.at(i), true);
    }
...
//#pragma mark -
//#pragma mark 赔率按钮
void GMMenuLayer::setMagnificationModel(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
...
//#pragma mark - action
void GMMenuLayer::pauseAction(Ref *pSender)
{
    GMGameLayer *temp = (GMGameLayer*)delegateGame;
    temp->pauseAction();
...
//    delegateGame->addChild(pauseLayer,Index_Pause,1);
    ...
    //    CCScene *pScene = CCTransitionFade::create(1.0, GMLoseLayer::scene(), Color3B::WHITE);
