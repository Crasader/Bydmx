...
void GMAchievementLayer::initElement()
{
    ...
    CCMenuItem *closeItem = CCMenuItemSprite::create(close, close1, CC_CALLBACK_1(GMAchievementLayer::backAction,this));
...
void GMAchievementLayer::backAction(Ref *pSender)
{
...
//    log("adjustPos (%f,%f)",adjustPos.x,adjustPos.y);
    // 调整位置
    scrollView->setContentOffsetInDuration(adjustPos, 0.5);
}

void GMAchievementLayer::scrollViewDidScroll(ScrollView* view)
{
    
}

void GMAchievementLayer::scrollViewDidZoom(ScrollView* view)
{
    
}

bool GMAchievementLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
//    m_bTouchedMenu =
...
void GMAchievementLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
//    if (m_bTouchedMenu)
    {
...
void GMAchievementLayer::onTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
...
void GMAchievementLayer::onTouchCancelled(CCTouch *pTouch, CCEvent *pEvent)
{
