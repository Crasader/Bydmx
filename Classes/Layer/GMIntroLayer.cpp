...
void GMIntroLayer::loadHomeData(int time)
{
    switch (time) {
        ...
        case 4:{
            ...
            CCMenuItem *menuItem = CCMenuItemSprite::create(normalSprite, normalSprite, CC_CALLBACK_1(GMIntroLayer::showAllMenu,this));
            ...
            CCMoveTo *moveTo1 = CCMoveTo::create(1, ccp(S_WINSIZE_W/2+145, 150));
            CCMoveTo *moveTo2 = CCMoveTo::create(1, ccp(S_WINSIZE_W/2+145, 95));
...
void GMIntroLayer::showMusic()
{
    ...
    if (billingModel == B_YiDong || billingModel == B_91_Android) {
        ...
        closeMusicItem = CCMenuItemSprite::create(homepage040, homepage041, CC_CALLBACK_1(GMIntroLayer::setMusicAtion,this));
        
        homepage040 = CCSprite::create("homepage062.png");
        homepage041 = CCSprite::create("homepage063.png");
        quitItem = CCMenuItemSprite::create(homepage040, homepage041, CC_CALLBACK_1(GMIntroLayer::setQuitAction,this));
        ...
        moreItem = CCMenuItemSprite::create(homepage040, homepage041, CC_CALLBACK_1(GMIntroLayer::setMoreAction,this));
        ...
        closeMusicItem = CCMenuItemSprite::create(homepage040, homepage041, CC_CALLBACK_1(GMIntroLayer::closeMusicAtion,this));
    }
    if(closeMusicItem){
        ...
        closeMusicMenu->setPosition(Vec2::ZERO);
        this->addChild(closeMusicMenu,3,MenuTag);
    }
}

//#pragma mark -
void GMIntroLayer::setMusicAtion(Ref *pSender){
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    showOpenMusicDialogLayer();
}

//#pragma mark - 移动退出游戏
void GMIntroLayer::setQuitAction(Ref *pSender){
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setGameOver();
...
void GMIntroLayer::setMoreAction(Ref *pSender){
//    GMPublicMethod::sharedPublicMethod()->setGameStatus(Home_Status);
...
void GMIntroLayer::closeMusicAtion(Ref *pSender)
{
...
void GMIntroLayer::showAllMenu(Ref *pSender)
{
    _isClick = true;
    ...
    this->schedule(schedule_selector(GMIntroLayer::updateData), 0.05f);
...
void GMIntroLayer::moveMenu(CCNode *object)
{
    ...
    CCMenuItem *menuItem1 = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMIntroLayer::startGame,this));
    menuItem1->setTag(1);
    ...
    CCMenuItem *menuItem2 = CCMenuItemSprite::create(normalSprite2, selectedSprite2, CC_CALLBACK_1(GMIntroLayer::startEndlessMode,this));
    menuItem2->setTag(2);
    ...
    CCMenuItem *menuItem3 = CCMenuItemSprite::create(normalSprite3, selectedSprite3, CC_CALLBACK_1(GMIntroLayer::achievementLayer,this));
    menuItem3->setTag(3);
    ...
    CCMenuItem *menuItem4 = CCMenuItemSprite::create(normalSprite4, selectedSprite4, CC_CALLBACK_1(GMIntroLayer::helpGame,this));
    menuItem4->setTag(4);
...
void GMIntroLayer::moveTo()
{
    ...
    for(int i = 0; i < child.size(); i++){
        CCMenuItem *menuItem = (CCMenuItem*)child.at(i);
...
void GMIntroLayer::startGame(Ref *pSender)
{
    _isClick = true;
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    this->cleanup();
...
//        CCScene *pScene = CCTransitionFade::create(0.0, GMCartoonLayer::scene(), Color3B::WHITE);
////        CCScene *pScene = CCTransitionFade::create(0.0, GMMainLayer::scene(), Color3B::WHITE);
//        CCDirector::sharedDirector()->replaceScene(pScene);
//#endif
    }
...
void GMIntroLayer::startEndlessMode(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    GMPublicMethod::sharedPublicMethod()->setShow91Pause(false);
...
//                pScene = CCTransitionFade::create(0.0, GMMainLayer::scene(), Color3B::WHITE);
//                CCDirector::sharedDirector()->replaceScene(pScene);
//            }
//            else
            {
...
void GMIntroLayer::helpGame(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
//    
...
void GMIntroLayer::winGame(){
    CCScene *pScene = CCTransitionFade::create(1.0, GMWinLayer::scene(), Color3B::WHITE);
    CCDirector::sharedDirector()->replaceScene(pScene);
}

void GMIntroLayer::loseGame(){
    CCScene *pScene = CCTransitionFade::create(0.0, GMLoseLayer::scene(), Color3B::WHITE);
    CCDirector::sharedDirector()->replaceScene(pScene);
}

void GMIntroLayer::achievementLayer(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
...
void GMIntroLayer::pauseLayerGame(){
    CCScene *pScene = CCTransitionFade::create(0.0, GMPauseLayer::scene(), Color3B::WHITE);
    CCDirector::sharedDirector()->replaceScene(pScene);
}
...
void GMIntroLayer::showMoreItem(){
    ...
    CCMenuItemSprite *homepage042 = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(GMIntroLayer::set91SdkAction, this));
    ...
    CCMenuItemSprite *homepage044 = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMIntroLayer::set91SdkAction,this));
    ...
    menu91->setPosition(Vec2::ZERO);
    this->addChild(menu91,3,MenuTag);
}

void GMIntroLayer::set91SdkAction(Ref *pSender){
...
void GMIntroLayer::openMusic(Ref *pSender)
{
...
void GMIntroLayer::closeMusic(Ref *pSender)
{
    ZPDialogLayer *dialogLayer = (ZPDialogLayer*)this->getChildByTag(1000);
    if (dialogLayer) {
        this->removeChild(dialogLayer, true);
...
//        CCMenuItem *menuItem1 = CCMenuItemSprite::create(normalSpriteOK, selectedSpriteOK, CC_CALLBACK_1(GMIntroLayer::confirmAtion));
//        menuItem1->setTag(1);
...
//        CCMenuItem *cancel = CCMenuItemSprite::create(normalSprite1, selectedSprite1, CC_CALLBACK_1(GMIntroLayer::cancelAtion));
//        cancel->setTag(2);
...
void GMIntroLayer::confirmAtion(Ref *pSender)
{
    CCDirector::sharedDirector()->end();
...
void GMIntroLayer::cancelAtion(Ref *pSender)
{
