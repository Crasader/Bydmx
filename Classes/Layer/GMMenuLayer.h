...
private:
    ...
    void loadData1();
    void initElement();
    void pauseAction(Ref *pSender);

    void smallerAction(Ref *pSender);//变小
    void largerAction(Ref *pSender);//变大
    ...
    void bugEnergyAction(Ref *object);
...
//    void setMagnificationModel();
    ...
    void addSkill();
    void usedSkill1(Ref *object);
    void usedSkill2(Ref *object);
    void showSkillNum();
public:
    int                 cannonIndex;
    bool                isLaser;
...
//    void addSkill(Ref* target, SEL_MenuHandler selector1,SEL_MenuHandler selector2);
...
//#pragma mark 倍率按钮
    void setMagnificationModel(Ref *pSender);
