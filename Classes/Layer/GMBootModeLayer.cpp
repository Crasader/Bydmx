...
void GMBootModeLayer::setInterceptionOfEvents()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(GMBootModeLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(GMBootModeLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(GMBootModeLayer::onTouchEnded, this);
...
void GMBootModeLayer::setSynopsisBg()
{
    ...
    CCMenuItem *item = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(GMBootModeLayer::nextAction,this));
...
//    labelt->setVerticalAlignment(kCCVerticalTextAlignmentCenter);
    ...
    switch (_storyStatus) {
        ...
        case 5:{
            ...
            CCMenuItem *item = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(GMBootModeLayer::sureAction,this));
        ...
        case 3:{ // 改变炮台
            ...
            specialMenu->setPosition(Vec2::ZERO);
...
//            plusItem = CCMenuItemSprite::create(normalSprite18, selectedSprite19, CC_CALLBACK_1(GMMenuLayer::largerAction));
...
void GMBootModeLayer::sureAction(Ref *pSender)
{
...
void GMBootModeLayer::nextAction(Ref *pSender)
{
...
void GMBootModeLayer::showDialogueNum()
{
    if (isShow == false && isShowDialogue2 == false) {
        ...
        auto item = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(GMBootModeLayer::sureAction,this));
        item->setPosition(ccp(312/2,40/2-8));
        CCRect rect = Get_Box(normalSprite);
        CCMenu *menu = CCMenu::create(item,NULL);
        menu->setPosition(Vec2::ZERO);
...
bool GMBootModeLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{

    return true;
}

void GMBootModeLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
}

void GMBootModeLayer::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
}
