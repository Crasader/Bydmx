...
void GMWinLayer::initElement()
{
    ...
    CCMenuItem *win009 = CCMenuItemSprite::create(win09, win10, CC_CALLBACK_1(GMWinLayer::chooseCard,this));
    ...
    if (currentLevel != 45) {
        ...
        win011 = CCMenuItemSprite::create(win11, win12, CC_CALLBACK_1(GMWinLayer::nextGame,this));
    ...
    CCMenuItem *arrow1 = CCMenuItemSprite::create(winarrow007, winarrow007, CC_CALLBACK_1(GMWinLayer::arrowAction1,this));

    CCSprite *winarrow008 = CCSprite::createWithSpriteFrameName("winarrow008.png");
    CCMenuItem *arrow2 = CCMenuItemSprite::create(winarrow008, winarrow008, CC_CALLBACK_1(GMWinLayer::arrowAction2,this));
...
void GMWinLayer::showStartPrompt(float dt){
    ...
    for (int i = 0; i < 3; i++) {
        if (i < starNum) {
            ...
            GMPublicMethod::setSpriteAnimation(start, 10, 15, "wineffect",0.2,this,callfuncN_selector(GMWinLayer::addStarEffect));
        }
    }
}
/*
...
// action 
void GMWinLayer::arrowAction1(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(false);
}

void GMWinLayer::arrowAction2(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(true);
}

void GMWinLayer::chooseCard(Ref *pSender)
{
...
void GMWinLayer::nextGame(Ref *pSender)
{
...
bool GMWinLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    //    m_bTouchedMenu =
...
void GMWinLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (moveW>0 && scrollView)
    {
...
void GMWinLayer::onTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
    if (moveW>0 && scrollView)
    {
...
void GMWinLayer::onTouchCancelled(CCTouch *pTouch, CCEvent *pEvent)
{
...
//}
//
//void GMWinLayer::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
//{
//    if (m_bTouchedMenu) {
