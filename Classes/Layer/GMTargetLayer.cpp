...
bool GMTargetLayer::init()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(GMTargetLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(GMTargetLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(GMTargetLayer::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(GMTargetLayer::onTouchCancelled, this);
...
void GMTargetLayer::initElement(int index,int index1)
{
    ...
    if (index == 0) {
        ...
        arrow1 = CCMenuItemSprite::create(normalSprite, NULL, CC_CALLBACK_1(GMTargetLayer::arrowAtion1,this));
        arrow1->setTag(1);
        ...
        arrow2 = CCMenuItemSprite::create(normalSprite2, NULL, CC_CALLBACK_1(GMTargetLayer::arrowAtion2,this));
        arrow2->setTag(2);
    ...
    if (index != 3) {
        ...
        OKItem = CCMenuItemSprite::create(normalSprite3, selectedImage3, CC_CALLBACK_1(GMTargetLayer::goAtion,this));
        OKItem->setTag(3);
        ...
        win002 = CCMenuItemSprite::create(normalSprite3, selectedImage3, CC_CALLBACK_1(GMTargetLayer::againAction,this));
        win002->setTag(3);
        ...
        win004 = CCMenuItemSprite::create(normalSprite4, selectedImage4, CC_CALLBACK_1(GMTargetLayer::backHomeAtion,this));
        win004->setTag(3);
...
void GMTargetLayer::showFishKind(int score,CCArray*array)
{
    ...
    if (array) {
        ...
        scrollView = ScrollView::create();// 位置不是居中的
        ...
        scrollView->setDirection(ScrollView::Direction::HORIZONTAL);  //设置滚动的方向，有三种可以选择
...
//#pragma mark -
//#pragma mark ation
void GMTargetLayer::arrowAtion1(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(false);
}

void GMTargetLayer::arrowAtion2(Ref *pSender){
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(true);
}

void GMTargetLayer::goAtion(Ref *pSender)
{
...
void GMTargetLayer::againAction(Ref *pSender)
{
   ((GMGameLayer*)_delegate)->againAction();
}

void GMTargetLayer::backHomeAtion(Ref *pSender)
{
...
bool GMTargetLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (scrollView) {
...
void GMTargetLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
//    if (scrollView) {
...
void GMTargetLayer::onTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
    if (scrollView) {
...
void GMTargetLayer::onTouchCancelled(CCTouch *pTouch, CCEvent *pEvent)
{
