...
void GMElementLayer::setOtheSkill(int goodId)
{
    if (!otherSkill) {
        ...
        otherSkill->setPosition(Vec2::ZERO);
    }
    bool isExist = false;
    Vector<Node*> object;
    CCMenuItemSprite *tempSkill = NULL;
	object = otherSkill->getChildren();
    for(int i = 0; i< object.size();i++){
        tempSkill = (MenuItemSprite*)object.at(i);
...
//        }
    ...
    if (isExist == false) {
        ...
        CCMenuItemSprite *tempSkill2 = CCMenuItemSprite::create(normalSprite, NULL, CC_CALLBACK_1(GMElementLayer::setOtheSkillEffect,this));
...
void GMElementLayer::setCountSillTime()
{
    if (isShow) {
        ...
        if (countSkillTime == 15 || countSkillTime == 20) {
            ...
            object = otherSkill->getChildren();
			for(int i = 0; i < object.size(); i++){
                tempSkill = (CCMenuItemSprite*)object.at(i);
...
void GMElementLayer::setOtheSkillEffect(Ref *pSender)
{
...
void GMElementLayer::setGiftAtion(Ref *pSender){
