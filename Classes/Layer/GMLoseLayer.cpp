...
void GMLoseLayer::initElement()
{
    ...
    if (n==0) {
        win009 = CCMenuItemSprite::create(win10, win9, CC_CALLBACK_1(GMLoseLayer::chooseCard,this));
        win009->setEnabled(false);
    }
    else {
        win009 = CCMenuItemSprite::create(win9, win10, CC_CALLBACK_1(GMLoseLayer::chooseCard,this));
    }
    ...
    CCMenuItem *win011 = CCMenuItemSprite::create(win011_0, win011_1, CC_CALLBACK_1(GMLoseLayer::againGame,this));
    ...
    CCMenuItem *arrow1 = CCMenuItemSprite::create(arrow1_0, arrow1_0, CC_CALLBACK_1(GMLoseLayer::arrowAtion,this));
    CCSprite *arrow1_1 = CCSprite::createWithSpriteFrameName("winarrow008.png");
    CCMenuItem *arrow2 = CCMenuItemSprite::create(arrow1_1, arrow1_1, CC_CALLBACK_1(GMLoseLayer::arrowAtion1,this));
...
void GMLoseLayer::arrowAtion(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(false);
}

void GMLoseLayer::arrowAtion1(Ref *pSender)
{
    GMAudioPlay::sharedAudioPlay()->playButtonEffect();
    setPage(true);
}

void GMLoseLayer::chooseCard(Ref *pSender)
{
...
void GMLoseLayer::againGame(Ref *pSender)
{
...
bool GMLoseLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    //    m_bTouchedMenu =
...
void GMLoseLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (moveW>0 && scrollView){
...
void GMLoseLayer::onTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
    if (moveW>0 && scrollView){
...
void GMLoseLayer::onTouchCancelled(CCTouch *pTouch, CCEvent *pEvent)
{
