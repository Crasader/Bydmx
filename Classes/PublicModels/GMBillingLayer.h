...
//#pragma mark - 91移动联网付费
    ...
    void textFieldAction(Ref *object);
    void getFriendAction(Ref *object);
    void getCodeAction(Ref *object);
    void sendCodeAction(Ref *object);
    
    
    void closeAction(Ref *pSender);
public:
//#pragma mark -
    void onEnter();
    void onExit();
