...
void ZPDialogLayer::initPromptLaser(Ref *targer,const char *string,SEL_CallFuncN sel)
{
    initView(NULL,"guide015.png");
    CCSprite *sprite = CCSprite::create("game/guide004.png");
    sprite->setAnchorPoint(ccp(0, 0));
...
void ZPDialogLayer::addMenu(const char *normalName,const char *selectedName,bool isFrame)
{
    ...
    CCMenuItem *item = CCMenuItemSprite::create(normalSprite, selectedSprite, CC_CALLBACK_1(ZPDialogLayer::removeDialogLayer,this));
...
void ZPDialogLayer::removeDialogLayer(Ref *pSender)
{
...
void ZPDialogLayer::onEnter()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(ZPDialogLayer::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(ZPDialogLayer::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(ZPDialogLayer::onTouchEnded, this);
	listener->onTouchCancelled = CC_CALLBACK_2(ZPDialogLayer::onTouchCancelled, this);
...
bool ZPDialogLayer::onTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_pMenu) {
...
void ZPDialogLayer::onTouchMoved(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
void ZPDialogLayer::onTouchEnded(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_bTouchedMenu && m_pMenu) {
...
void ZPDialogLayer::onTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
    if (m_bTouchedMenu && m_pMenu) {
